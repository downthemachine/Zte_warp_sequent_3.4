...
system ("$dir/mkbootimg --cmdline 'cmdline = androidboot.hardware=qcom loglevel=1 vmalloc=200M' --kernel zImage --ramdisk ramdisk-repack.gz -o boot.img --base 0x00200000 --pagesize 4096");
